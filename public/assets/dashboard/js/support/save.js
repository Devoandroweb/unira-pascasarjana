...
var _LOADING = `<div class="w-100 d-flex align-items-center">
        ...
        function saveForm(
            ...
            return new Promise((resolve, reject) => {  // Tambahkan 'return' di sini
...
function clearInput(form) {
    ...
    form.find(
        "input[type=hidden],input[type=text],input[type=password],input[type=email],input[type=file],textarea"
    ).val("");
    form.find("input[type=file]").val(null);

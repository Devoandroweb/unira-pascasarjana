                        ...
                        a.each(e, function () {
                            (c -= parseFloat(a.css(b, "padding" + this)) || 0),
                                d &&
                                    (c -=
                                        parseFloat(
                                            a.css(b, "border" + this + "Width")
                                        ) || 0),
                                f &&
                                    (c -=
                                        parseFloat(a.css(b, "margin" + this)) ||
                                        0);
                        }),
                        c
                    );
                ...
                if (!b) {
                    ...
                    var d = this,
                        ...
                        f =
                            ...
                            c.target.nodeName
                                ? a(c.target).closest(this.options.cancel)
                                      .length
                                : !1;
                ...
                return (
                    ...
                    this._mouseStarted
                        ...
                        : (this._mouseDistanceMet(b) &&
                              ...
                              ((this._mouseStarted =
                                  this._mouseStart(this._mouseDownEvent, b) !==
                                  !1),
                              this._mouseStarted
                                  ? this._mouseDrag(b)
                                  : this._mouseUp(b)),
        ...
        _mouseCapture: function (b, c) {
            ...
            return this.reverting
                ...
                : (this._refreshItems(b),
                  ...
                  a.data(b.target, f.widgetName + "-item") === f &&
                      (d = a(b.target)),
                  d &&
                  (!this.options.handle ||
                      c ||
            ...
            for (
                ...
                if (
                    ...
                    f &&
                        ...
                        this.placeholder[1 === f ? "next" : "prev"]()[0] !==
                            e &&
            ...
            "parent" === e.containment &&
                ...
                ("document" === e.containment || "window" === e.containment) &&
                    (this.containment = [
                        ...
                        a(
                            "document" === e.containment ? document : window
                        ).width() -
                            this.helperProportions.width -
                            this.margins.left,
                        (a(
            ...
            return (
                ...
                this.originalPosition &&
                    ...
                    e.grid &&
                        ((c =
                            this.originalPageY +
                            Math.round((g - this.originalPageY) / e.grid[1]) *
                                e.grid[1]),
                        (g = this.containment
                        ...
                        (d =
                            this.originalPageX +
                            Math.round((f - this.originalPageX) / e.grid[0]) *
                                e.grid[0]),
                        (f = this.containment
                    ...
                    e.containment
                        ? "window" === e.containment
                            ? void (this.containment = [
                                  ...
                                  a(window).scrollTop() +
                                      (a(window).height() ||
                                          f.body.parentNode.scrollHeight) -
                                      this.helperProportions.height -
                                      this.margins.top,
                              ])
                                  ...
                                  (this.containment = [
                                      (parseInt(c.css("borderLeftWidth"), 10) ||
                                          ...
                                          (parseInt(c.css("paddingLeft"), 10) ||
                                              0),
                                      (parseInt(c.css("borderTopWidth"), 10) ||
                                          0) +
                    ...
                    (f.positionAbs = d.positionAbs),
                        ...
                        e
                            ? (f.isOver ||
                                  ...
                                  (f.fromOutside = d)),
                              f.currentItem &&
                                  (f._mouseDrag(b), (c.position = f.position)))
                            : f.isOver &&
                              ((f.isOver = 0),
                ...
                g !== h && "HTML" !== g.tagName
                    ? ((e.axis && "x" === e.axis) ||
                          ...
                          e.scrollSensitivity
                              ...
                              : b.pageY - d.overflowOffset.top <
                                    e.scrollSensitivity &&
                                (g.scrollTop = f =
                                    g.scrollTop - e.scrollSpeed)),
                      (e.axis && "y" === e.axis) ||
                          (d.overflowOffset.left + g.offsetWidth - b.pageX <
                          e.scrollSensitivity
                              ? (g.scrollLeft = f =
                                    g.scrollLeft + e.scrollSpeed)
                    ...
                    : ((e.axis && "x" === e.axis) ||
                          (b.pageY - a(h).scrollTop() < e.scrollSensitivity
                              ? (f = a(h).scrollTop(
                                    a(h).scrollTop() - e.scrollSpeed
                                ))
                              : a(window).height() -
                                    (b.pageY - a(h).scrollTop()) <
                                    e.scrollSensitivity &&
                                (f = a(h).scrollTop(
                                    a(h).scrollTop() + e.scrollSpeed
                                ))),
                      (e.axis && "y" === e.axis) ||
                          (b.pageX - a(h).scrollLeft() < e.scrollSensitivity
                              ? (f = a(h).scrollLeft(
                                    a(h).scrollLeft() - e.scrollSpeed
                                ))
                              : a(window).width() -
                                    (b.pageX - a(h).scrollLeft()) <
                                    e.scrollSensitivity &&
                                (f = a(h).scrollLeft(
                                    a(h).scrollLeft() + e.scrollSpeed
                                )))),
...
!(function (a) {
    ...
    postboxes = {
        add_postbox_toggles: function (c, d) {
            ...
            e.init(c, d),
                a(".postbox .hndle, .postbox .handlediv").bind(
                    ...
                    function () {
                        ...
                        "dashboard_browser_nag" != f &&
                            ...
                            "press-this" != c && e.save_state(c),
                            f &&
                                (!d.hasClass("closed") &&
                                a.isFunction(postboxes.pbshow)
                                    ? e.pbshow(f)
                                    : d.hasClass("closed") &&
                                      a.isFunction(postboxes.pbhide) &&
                                      e.pbhide(f)),
                            b.trigger("postbox-toggled", d));
                    }
                ),
                ...
                a(".hide-postbox-tog").bind("click.postboxes", function () {
                    ...
                    a(this).prop("checked")
                        ? (f.show(),
                          a.isFunction(postboxes.pbshow) && e.pbshow(d))
                        : (f.hide(),
                          a.isFunction(postboxes.pbhide) && e.pbhide(d)),
                        e.save_state(c),
                        e._mark_area(),
        ...
        _mark_area: function () {
            ...
            a("#dashboard-widgets .meta-box-sortables:visible").each(
                function () {
                    var c = a(this);
    ...
    (b = wpNavMenu =
        {
            ...
            init: function () {
                (b.menuList = a("#menu-to-edit")),
                    ...
                    menus.oneThemeLocationNoMenus &&
                        a("#posttype-page").addSelectedToMenu(
            ...
            jQueryExtensions: function () {
                a.fn.extend({
                    menuItemDepth: function () {
                        var a = this.eq(0).css(
                            b.isRTL ? "margin-right" : "margin-left"
                        );
                        return b.pxToDepth(
                            a && -1 != a.indexOf("px") ? a.slice(0, -2) : 0
                        );
                    },
                    ...
                    updateParentMenuItemDBId: function () {
                        return this.each(function () {
                            ...
                            c.val(
                                0 === d
                                    ? 0
                                    : f.find(".menu-item-data-db-id").val()
                            );
                        });
                    },
                    hideAdvancedMenuItemFields: function () {
                        return this.each(function () {
                            ...
                            a(".hide-column-tog")
                                .not(":checked")
                                .each(function () {
                                    b.find(".field-" + a(this).val()).addClass(
                                        "hidden-field"
                                    );
                                });
                        });
                ...
                switch (d) {
                    ...
                    case "down":
                        if (k) {
                            ...
                            if (
                                (0 !== p.length && j.moveHorizontally(q, m),
                                i === n + 1)
                            )
                                break;
                            j.detach()
            ...
            initAccessibility: function () {
                ...
                b.refreshKeyboardAccessibility(),
                    b.refreshAdvancedAccessibility(),
                    c.on("click", ".menus-move-up", function (c) {
                        b.moveMenuItem(
            ...
            refreshAdvancedAccessibility: function () {
                a(".menu-item-settings .field-move a").css("display", "none"),
                    a(".item-edit").each(function () {
                        var b,
                            ...
                            r = l
                                .prevAll(".menu-item-depth-" + q)
                                .first()
                                .find(".menu-item-title")
                                .text(),
                            s = l
                                .prevAll(".menu-item-depth-" + m)
                                .first()
                                .find(".menu-item-title")
                                .text(),
                        ...
                        0 !== p &&
                            ((b = l.find(".menus-move-up")),
                            b.css("display", "inline")),
                            0 !== p &&
                                n &&
                                ((b = l.find(".menus-move-top")),
                                b.css("display", "inline")),
                            p + 1 !== t &&
                                0 !== p &&
                                ((b = l.find(".menus-move-down")),
                                b.css("display", "inline")),
                            0 === p &&
                                0 !== u &&
                                ((b = l.find(".menus-move-down")),
                                b.css("display", "inline")),
                            n ||
                                ((b = l.find(".menus-move-left")),
                                (c = menus.outFrom.replace("%s", r)),
                                b.html(c).css("display", "inline")),
                            0 !== p &&
                                l.find(".menu-item-data-parent-id").val() !==
                                    l
                                        ...
                                        .val() &&
                                ((b = l.find(".menus-move-right")),
                                (c = menus.under.replace("%s", s)),
                                b.html(c).css("display", "inline")),
                            n
                                ? ((d = a(".menu-item-depth-0")),
                                  (e = d.index(l) + 1),
                                  (t = d.length),
                                  (f = menus.menuFocus
                                      .replace("%1$s", o)
                                ...
                                : ((g = l
                                      .prevAll(
                                          ".menu-item-depth-" + parseInt(m - 1, 10)
                                      )
                                      .first()),
                                  (h = g.find(".menu-item-data-db-id").val()),
                                  (i = g.find(".menu-item-title").text()),
                                  (j = a(
                                  ...
                                  (e =
                                      a(
                                          j.parents(".menu-item").get().reverse()
                                      ).index(l) + 1),
                                  (f = menus.subMenuFocus
                                      .replace("%1$s", o)
                                      .replace("%2$d", e)
                                      .replace("%3$s", i))),
                            k.html(f);
            ...
            initSortables: function () {
                function c(a) {
                    ...
                    (j = a.placeholder.prev()),
                        (k = a.placeholder.next()),
                        j[0] == a.item[0] && (j = j.prev()),
                        k[0] == a.item[0] && (k = k.next()),
                ...
                function f(c) {
                    ...
                    if (0 !== c) {
                        if (c > 0) (d = p + c), d > t && (e = d);
                            ...
                            for (
                                ;
                                !a(".menu-item-depth-" + e, b.menuList)
                                    .length && e > 0;
                    ...
                    b.menuList.sortable({
                        ...
                        sort: function (e, f) {
                            var g = f.helper.offset(),
                                j = b.isRTL
                                    ? g.left + f.helper.width()
                                    : g.left,
                                o = b.negateIfRTL * b.pxToDepth(j - r);
                            o > i || g.top < l ? (o = i) : h > o && (o = h),
                                o != q && d(f, o),
                                m &&
                                    g.top + n > m &&
            ...
            initManageLocations: function () {
                a("#menu-locations-wrap form").submit(function () {
                    ...
                    a(".menu-location-menus select").on("change", function () {
                        ...
                        a(this).find("option:selected").data("orig")
                            ? b.show()
                            : b.hide();
                    });
            },
            attachMenuEditListeners: function () {
                ...
                a("#update-nav-menu").bind("click", function (a) {
                    ...
                    a('#add-custom-links input[type="text"]').keypress(
                        function (b) {
                            13 === b.keyCode &&
                                (b.preventDefault(),
                    ...
                    if (h.hasClass("nav-tab-link"))
                        ...
                        if (h.hasClass("submit-add-to-menu"))
                            return (
                                b.registerChange(),
                                c.target.id &&
                                "submit-customlinkdiv" == c.target.id
            ...
            eventOnClickMenuItemDelete: function(c, event) {
                // Cegah event default untuk menghindari refresh halaman
                if (event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        deleteitem(d);  // Panggil fungsi deleteitem untuk melakukan penghapusan
                        
                        // Menghapus item dari menu dan mendaftarkan perubahan
                        b.removeMenuItem(a("#menu-item-" + d)); 
                        b.registerChange();
                    }
                });
            
                return false; // Pastikan tidak ada aksi lebih lanjut setelah SweetAlert
            },
            processQuickSearchQueryResponse: function (b, c, d) {
                ...
                return k.length
                    ? (k.each(function () {
                          if (
                              ((g = a(this)), (e = j.exec(g.html())), e && e[1])
                          ) {
                              for (
                                  f = e[1];
                                  i.elements[
                                      "menu-item[" + f + "][menu-item-type]"
                                  ] || h[f];
                    ...
                    function () {
                        ...
                        b.remove(),
                            ...
                            0 === a("#menu-to-edit li").length &&
                                ...
                                d.removeClass("menu-instructions-inactive"));
                    }
                );
            },

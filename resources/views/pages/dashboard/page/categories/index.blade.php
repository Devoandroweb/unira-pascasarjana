...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 text-end">
                            ...
                            <a href="{{ route('dashboard.page-category.trash') }}" class="btn btn-danger btn-sm">{{ __('Trash') }}</a>
                        </div>
    ...
    @widget('modal', ['title' => __($title), 'form' => 'pages.dashboard.page.categories.form', 'data' => [], 'type' => ''])
    @widget('delete',['dt'=> true])
@endsection
@push('js')
    <script>
        var _URL = "{{ route('datatable.pages.categories') }}"
        var _COLUMNS = [{
                title: '#',
                data: 'DT_RowIndex',
                orderable: false,
